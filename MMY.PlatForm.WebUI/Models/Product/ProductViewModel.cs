    ...
    public class ProductViewModel
    {
      ...
      //  public int DisplayOrder { get; set; }
        ...
        public static ProductViewModel CopyFrom(Data.Model.Product product)
        {
            ...
            var classes= product.ProductClassification.Where(q=>!q.IsDeleted).Select(item => ProductClassificationViewModel.CopyFrom(item)).ToList();
            var albumList = product.ProductAlbum.Where(q=>!q.IsDeleted).Select(item => ProductAlbumViewModel.CopyFrom(item)).ToList();
